...
class FirebaseService {
  ...
  Future<void> addToWishlist(String userId, Map<String, dynamic> hotelData) async {
    try {
  ...
  Future<void> removeFromWishlist(String userId, String hotelId) async {
    try {
      await _usersCollection.doc(userId).collection('wishlist').doc(hotelId).delete();
    } catch (e) {
